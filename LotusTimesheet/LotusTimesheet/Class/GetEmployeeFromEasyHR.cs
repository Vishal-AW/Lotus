    ...
    public class GetEmployeeFromEasyHR
    {
        ...
        public List<EmployeeModel> GetEmployeAttendance()
        {
           ...
           // var Url = "https://lotustechnicals.easyhrworld.com/api/v2/attendance/getEmployeeAttendanceByRange?start_date=2020-10-13";
            var Url = "https://lotustechnicals.easyhrworld.com/api/v2/attendance/getEmployeeAttendanceByRange?start_date=" + dataDateValue.ToString("yyyy-MM-dd") + "&end_date=" + dataDateValue.ToString("yyyy-MM-dd");
        ...
        public EmployeeModel CheckNewEntry(string EMPCode, string siteUrl)
        {
            ...
            using (MSC.ClientContext context = GetContext(siteUrl))
            {
                ...
                var q = new CamlQuery() { ViewXml = "<View><Query><Where><And><Eq><FieldRef Name='EmpNo' /><Value Type='Text'>"+ EMPCode + "</Value></Eq><Eq><FieldRef Name='AttendanceDate' /><Value Type='Text'>" + dataDateValue.ToString("dd-MM-yyyy")+"</Value></Eq></And></Where></Query></View>" };
